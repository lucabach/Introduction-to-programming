...
public class Main {
	...
	public static void count(final Counter counter, int numThreads, ThreadCounterType type, int numInterations) {
		...
		for (int i = 0; i < numThreads; i++) {
			Thread t = new Thread(ThreadCounterFactory.make(type, counter, i, numThreads, numInterations));
			threads.add(t);
		}
...
//		taskE();
	...
	public static void taskD(){
		Counter counter = new SynchronizedCounter();  //TODO: which type of counter can we use here?
